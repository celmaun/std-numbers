...
describe('Test number parsing functions', () => {
    describe('parsei32()', () => {
        ...
        it('should throw a RangeError on out-of-range `number` numbers', () => {
            ...
            expect(() => parsei32(-7414227031455547483649)).toThrow(RangeError);
        ...
        it('should parse a valid i32 string', () => {
            expect(parsei32('123')).toBe(123);
        ...
        it('should parse a valid negative i32 string', () => {
            expect(parsei32('-123')).toBe(-123);
        });
        ...
        it('should handle edge cases for valid i32 strings', () => {
            expect(parsei32('0')).toBe(0);
            expect(parsei32('1')).toBe(1);
            expect(parsei32('-1')).toBe(-1);
        });
